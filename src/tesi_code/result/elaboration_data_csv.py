...
mix.apply_heading_correction("heading map_base_link")
mix.remove_offset("updated_indeg_heading map_base_link")
...
mix.calculate_error_dist("amcl_odom", "rmOffSet_X (m) map_base_link","rmOffSet_Y (m) map_base_link")
